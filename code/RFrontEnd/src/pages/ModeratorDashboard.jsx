...
export default function ModeratorDashboard() {
  ...
  const statusData = [58, 72, 65, 80, 68, 85, 70, 78, 82, 75];
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-cards-row">
        <div className="dashboard-info-card role">
          ...
          <div className="dashboard-card-value">moderator</div>
        </div>
          ...
          <div className="access-chart-container">
            <svg width="160" height="160" viewBox="0 0 160 160">
              ...
              <circle
                ...
                r={60}
                fill="none"
                stroke="url(#modSecuredGradient)"
                strokeWidth="20"
                strokeDasharray={`${282.7} ${94.2}`}
                transform="rotate(-90 80 80)"
              />
              <defs>
                <linearGradient id="modSecuredGradient" x1="0%" y1="0%" x2="100%" y2="0%">
